...
export default {
  ...
  watch: { 
    trigger: function(newVal, oldVal) {
      if (newVal - oldVal === 1 && this.isCurrent === true) {
        this.playCard(ACCEPT_CARD);  
      } else if (oldVal - newVal === 1 && this.isCurrent === true) {
...
.card {
  ...
  // background-image: url("../assets/bricklane.png");
